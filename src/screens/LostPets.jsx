...
const LostPets = () => {
  ...
  const verifyPost = () => {
    if (!petName || !petType || !petGender || !petSize || !petDescription || !petLocation || !date || !time || !petImage) {
  ...
  const handlePost = async () => {
    ...
    try {
      const storageRef = ref(storage, `lostPetPosts/${petImage.name}`);
      ...
      const docRef = await addDoc(collection(db, "lostPetPosts"), {
        petName: petName,
        petType: petType,
        petGender: petGender,
        petSize: petSize,
    ...
    <A>
     ...
     {/* <div style={{width: 430, height: 932,display: 'flex',flexDirection: 'column',}}> */}
      ...
      <div style={{ width: '90%',height: '100%',marginTop: '0%',display: 'flex',flexDirection: 'column',alignItems: 'flex-start',}}>
              ...
              <h2 style={{ marginTop: '7%',alignSelf: 'flex-start',fontSize: 25,fontFamily: 'cursive',color: 'black'}}>What's your pet's name?</h2>
              <label style={{ width: '100%',display: 'flex',flexDirection: 'row',alignSelf: 'flex-start',fontSize: 18,fontFamily: 'cursive',color: 'black'}}>
        <FaPenAlt size={45} style={{color: 'black',marginTop: '5px'}}/>
        <input style={{ boxShadow: '0px 5px 20px 0px rgba(0,0,0,0.7)',marginLeft: '3%',borderWidth: '4px', borderRadius: '200px', borderColor: 'black', backgroundColor: 'white', width: '100%', height: '7%', paddingLeft: '30px', paddingRight: '30px', marginTop: '5px',paddingBlock: '6%' }} value={petName} onChange={(e) => setPetName(e.target.value)} type='text' placeholder="Write your furry pal's name"></input>
      </label>   

              <h2 style={{ width: '100%',marginTop: '3%',alignSelf: 'flex-start',fontSize: 25,fontFamily: 'cursive',color: 'black'}}>What kind of pet is it?</h2>
              ...
              <h2 style={{ width: '100%',marginTop: '10%',alignSelf: 'flex-start',fontSize: 25,fontFamily: 'cursive',color: 'black'}}>Where did it get lost?</h2>
              <label style={{ width: '100%',display: 'flex',flexDirection: 'row',alignSelf: 'flex-start',fontSize: 18,fontFamily: 'cursive',color: 'black'}}>
                <BsGeoAltFill size={45} style={{color: 'black',marginTop: '5px'}}/>
                <input style={{ boxShadow: '0px 5px 20px 0px rgba(0,0,0,0.7)',marginLeft: '2%',borderWidth: '4px', borderRadius: '200px', borderColor: 'black', backgroundColor: 'white', width: '100%', height: '7%', paddingLeft: '30px',paddingRight: '30px', marginTop: '5px',paddingBlock: '6%' }} value={petLocation} onChange={(e) => setPetLocation(e.target.value)} type='text' placeholder="Place where you last saw it"></input>
              </label>
              ...
              <h2 style={{ width: '100%',marginTop: '10%',alignSelf: 'flex-start',fontSize: 25,fontFamily: 'cursive',color: 'black'}}>Upload a picture of your pet</h2>
        ...
        id="multiline-input"
        // value={''}
        placeholder="E.g. My cat is a Persian breed, it has brown fur and black spots..."
